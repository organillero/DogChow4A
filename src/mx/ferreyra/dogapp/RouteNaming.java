...
public class RouteNaming extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fb.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "http://www.dogchow.com.mx/" );
                startActivity(Intent.createChooser(intent, "Share with"));
                
                //shareByAndroid("DogChow", "He corrido con DogChow chow mi Ruta: " + editText.getText().toString());
        ...
        twr.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // shareByAndroid("DogChow", "He corrido con DogChow chow mi Ruta: " + editText.getText().toString());
                ...
                i.putExtra(Intent.EXTRA_TEXT, "He corrido con DogChow mi ruta: " + editText.getText().toString() );
    ...
    /*
    public void shareByAndroid (String subject , String message){
